<div>
    ...
    white-space: initial;
        ...
        <script src='/delicioz/wp-content/plugins/woocommerce/assets/js/frontend/country-select.min.js?ver=6.8.2'
        ...
        <script src='/delicioz/wp-content/plugins/woocommerce/assets/js/frontend/address-i18n.min.js?ver=6.8.2'
