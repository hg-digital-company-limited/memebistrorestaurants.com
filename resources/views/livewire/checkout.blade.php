<div>
    ...
    <head>
        ...
        <link rel="alternate" type="application/json"
            href="https://demo2.themelexus.com/delicioz/wp-json/wp/v2/pages/11" />
        ...
        <link rel="canonical" href="https://demo2.themelexus.com/delicioz/checkout/" />
        <link rel='shortlink' href='https://demo2.themelexus.com/delicioz/?p=11' />
        <link rel="alternate" type="application/json+oembed"
            href="https://demo2.themelexus.com/delicioz/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fdemo2.themelexus.com%2Fdelicioz%2Fcheckout%2F" />
        <link rel="alternate" type="text/xml+oembed"
            href="https://demo2.themelexus.com/delicioz/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fdemo2.themelexus.com%2Fdelicioz%2Fcheckout%2F&#038;format=xml" />
        <noscript>
            <style>
    ...
    <body
                                ...
                                <div class="entry-content">
                                    <div class="woocommerce">
                                        ...
                                        <form name="checkout" method="post" class="checkout woocommerce-checkout"
                                            action="https://demo2.themelexus.com/delicioz/checkout/"
                                                        ...
                                                        <div class="woocommerce-billing-fields__field-wrapper">
                                                            ...
                                                            <p class="form-row form-row-last validate-required"
                                                                id="billing_last_name_field" data-priority="20"><label
                                                                    for="billing_last_name" class="">Last
                                                                    name&nbsp;<abbr class="required"
                                                                        title="required">*</abbr></label><span
                                                                    class="woocommerce-input-wrapper"><input type="text"
                                                            ...
                                                            <p class="form-row form-row-wide address-field validate-required validate-state"
                                                                id="billing_state_field" data-priority="80"><label
                                                                    for="billing_state" class="">State&nbsp;<abbr
                                                                        class="required"
                                                                        title="required">*</abbr></label><span
                                                                    class="woocommerce-input-wrapper"><select
                                                            ...
                                                            <p class="form-row form-row-wide address-field validate-required validate-postcode"
                                                                id="billing_postcode_field" data-priority="90"><label
                                                                    for="billing_postcode" class="">ZIP Code&nbsp;<abbr
                                                                        class="required"
                                                                        title="required">*</abbr></label><span
                                                                    class="woocommerce-input-wrapper"><input type="text"
                                                            ...
                                                            <p class="form-row form-row-wide validate-required validate-email"
                                                                id="billing_email_field" data-priority="110"><label
                                                                    ...
                                                                    class="woocommerce-input-wrapper"><input
                                                                        ...
                                                                        placeholder="" value="2509roblox@gmail.com"
                                                ...
                                                <div id="payment" class="woocommerce-checkout-payment">
                                                    <ul class="wc_payment_methods payment_methods methods">
                                                        <li
                                                            ...
                                                            or wish to make alternate arrangements.</li>
                                                    </ul>
                                                    <div class="form-row place-order">
                                                        ...
                                                        <input type="hidden" id="woocommerce-process-checkout-nonce"
                                                            ...
                                                            value="8d9f73c9a4" /><input type="hidden"
                                                            name="_wp_http_referer" value="/delicioz/checkout/" />
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="form-style">
                                                                    ...
                                                                    <form id="mc4wp-form-1"
                                                                        ...
                                                                        <div class="mc4wp-form-fields">
                                                                            ...
                                                                            value="1741576528" /><input type="hidden"
                                                        ...
                                                        <div class="elementor-element elementor-element-b07bab7 elementor-widget__width-initial elementor-widget elementor-widget-text-editor"
                                                            ...
                                                            <div class="elementor-widget-container">
                                                                <a href="/cdn-cgi/l/email-protection"
                                                                    class="__cf_email__"
                                                                    data-cfemail="daa8bfa9bfa8acbbaeb3b5b4a99abfa2bbb7aab6bff4b9b5b7">[email&#160;protected]</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li class="page_item page-item-11 current_page_item"><a
                                    href="https://demo2.themelexus.com/delicioz/checkout/"
                                    aria-current="page">Checkout</a></li>
        ...
        <script
            type="application/ld+json">{"@context":"https:\/\/schema.org\/","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"name":"Home Page","@id":"https:\/\/demo2.themelexus.com\/delicioz"}},{"@type":"ListItem","position":2,"item":{"name":"Checkout","@id":"https:\/\/demo2.themelexus.com\/delicioz\/checkout\/"}}]}</script>
        ...
        <script id='wc-checkout-js-extra'>
            var wc_checkout_params = { "ajax_url": "\/delicioz\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/delicioz\/?wc-ajax=%%endpoint%%", "update_order_review_nonce": "1f878d4100", "apply_coupon_nonce": "1184aae44f", "remove_coupon_nonce": "6cb0e73d5e", "option_guest_checkout": "yes", "checkout_url": "\/delicioz\/?wc-ajax=checkout", "is_checkout": "1", "debug_mode": "", "i18n_checkout_error": "Error processing checkout. Please try again." };
        </script>
        <script
            src='https://demo2.themelexus.com/delicioz/wp-content/plugins/woocommerce/assets/js/frontend/checkout.min.js?ver=6.8.2'
