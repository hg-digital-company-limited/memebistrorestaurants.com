<div>
    ...
    <head>
        ...
        <link rel='stylesheet' id='elementor-post-103-css'
            href='/delicioz/wp-content/uploads/elementor/css/post-103.css?ver=1661951546' media='all' />
                            ...
                            <nav id="post-navigation" class="navigation pagination" role="navigation"
                                ...
                                <div class="nav-links">
                                    <ul class='page-numbers'>
                                        ...
                                        @else
                                        <li><a class="next page-numbers" href="{{ $promotions->previousPageUrl() }}"><span></span><i class="delicioz-icon delicioz-icon-arrow-left-s-line"></i></a></li>
                                        ...
                                        @if ($promotions->hasMorePages())
                                            <li><a class="next page-numbers" href="{{ $promotions->nextPageUrl() }}"><span></span><i class="delicioz-icon delicioz-icon-arrow-right-s-line"></i></a></li>
                                        @endif
                                    </ul>
                                </div>
                            </nav>
