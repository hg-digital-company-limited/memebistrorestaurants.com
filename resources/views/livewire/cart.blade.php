                                                ...
                                                <tbody>
                                                    @if ($cartItems)
                                                        ...
                                                        <td class="product-name" data-title="Product">
                                                            <a
                                                                href="/delicioz/product/rustic-linen-shirt/">{{ $item['name'] }}</a>
                                                        </td>

                                                        <td class="product-price" data-title="Price">
                                                            <span class="woocommerce-Price-amount amount"><bdi><span
                                                                        class="woocommerce-Price-currencySymbol"></span>{{ number_format($item['unit_amount'], 0, ',', '.') }} VNĐ</bdi></span>
                                                        </td>
                                                        ...
                                                        <td class="product-subtotal" data-title="Subtotal">
                                                            <span class="woocommerce-Price-amount amount"><bdi><span
                                                                        class="woocommerce-Price-currencySymbol"></span>{{ number_format($item['total_amount'], 0, ',', '.') }} VNĐ</bdi></span>
                                                        </td>
                                                    </tr>
