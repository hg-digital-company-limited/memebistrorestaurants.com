<div>
    ...
    <body
            ...
            <div class="account-inner ">
                <div class="login-form-head">
                    ...
                    <span class="pull-right">
                        <a class="register-link" href="/delicioz/my-account/"
                ...
                <div class="login-form-bottom">
                    <a href="/delicioz/my-account/lost-password/" class="lostpass-link"
                    ...
                    <div class="handheld-navigation">
                        <ul id="menu-main-menu" class="menu">
                            ...
                            <li
                                ...
                                <a href="/delicioz/shop/" aria-current="page">Shop</a>
                                <ul class="sub-menu">
                                    <li
                                        class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-507">
                                        <a href="/delicioz/shop/?woocommerce_archive_sidebar=left"
        ...
        <link rel='stylesheet' id='elementor-post-537-css'
            href='/delicioz/wp-content/uploads/elementor/css/post-537.css?ver=1661951553'
            media='all' />
        ...
        <script src='/delicioz/wp-includes/js/jquery/ui/slider.min.js?ver=1.13.1'
            id='jquery-ui-slider-js'></script>
        <script
            src='/delicioz/wp-content/plugins/woocommerce/assets/js/jquery-ui-touch-punch/jquery-ui-touch-punch.min.js?ver=6.8.2'
            id='wc-jquery-ui-touchpunch-js'></script>
        <script
            src='/delicioz/wp-content/plugins/woocommerce/assets/js/accounting/accounting.min.js?ver=0.4.2'
            id='accounting-js'></script>
        <script id='wc-price-slider-js-extra'>
            var woocommerce_price_slider_params = { "currency_format_num_decimals": "0", "currency_format_symbol": "$", "currency_format_decimal_sep": ".", "currency_format_thousand_sep": ",", "currency_format": "%s%v" };
        </script>
        <script
            src='/delicioz/wp-content/plugins/woocommerce/assets/js/frontend/price-slider.min.js?ver=6.8.2'
